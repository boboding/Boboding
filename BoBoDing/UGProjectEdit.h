// CUGProjectEdit.h : interface of the CUGProjectEdit class
//
/////////////////////////////////////////////////////////////////////////////
#include "ugctrl.h"
#include "boboding.h"
...
class CUGProjectEdit:public CUGCtrl
{
public:
	CUGProjectEdit();
	~CUGProjectEdit();
...
public:
	...
	int m_nRows ;
	int m_nCols ;
	long GetRowCount(CString strClass);
	// 获取单据编号
	CString GetProjectName(int nCol,long nRow);

	void SQLQuery(CString strClass);
	void InitData(CString strClass);
