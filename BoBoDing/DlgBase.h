...
//#include "DlgSearch.h"
////#include "DlgMall.h"
//#include "DlgTuanGou.h"
//#include "DlgZhiFu.h"
//#include "DlgHuoDong.h"
//#include "DlgMemo.h"
//#include "DlgAbout.h"
//#include "DlgKuaiDi.h"
//
...
#include "DlgSet.h"
#include "DlgAbout.h"
#include "DlgShopping.h"//购物
#include "DlgSetting.h"//设置
#include "DlgWeb.h" //网站导航
#include "DlgTool.h"
#include "DlgShop.h"

#include "DlgNote.h" //备忘录
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	bool SetCustomStyle(bool bIsImageStyle, CString strCustomBKImage = L"");
protected:
...
public:
	...
	CDlgMemo  m_DlgMemo;
	CDlgAddressBook  m_DlgAddressBook;
	CDlgJiZhang m_DlgJiZhang;
	CDlgSet   m_DlgSet;
	CDlgAbout  m_AboutDlg;
	CDlgWeb m_DlgWeb;
	CDlgShop m_DlgShop;
	CDlgTool m_DlgTool;
	CDlgNote m_DlgNote;
