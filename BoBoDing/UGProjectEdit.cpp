...
BEGIN_MESSAGE_MAP(CUGProjectEdit,CUGCtrl)
	//{{AFX_MSG_MAP(CUGProjectEdit)
...
/////////////////////////////////////////////////////////////////////////////
// Standard CUGProjectEdit construction/destruction
CUGProjectEdit::CUGProjectEdit()
{
...
//	Return:
//		<none>
void CUGProjectEdit::OnSheetSetup(int sheetNumber)
{
...
int CUGProjectEdit::OnCanMove(int oldcol,long oldrow,int newcol,long newrow)
{
...
int CUGProjectEdit::OnCanViewMove(int oldcol,long oldrow,int newcol,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newcol);
...
//	Return:
//		<none>
void CUGProjectEdit::OnHitBottom(long numrows,long rowspast,long rowsfound)
{
...
//	Return:
//		<none>
void CUGProjectEdit::OnHitTop(long numrows,long rowspast)
{
	UNREFERENCED_PARAMETER(numrows);
	UNREFERENCED_PARAMETER(rowspast);
}
...
int CUGProjectEdit::OnCanSizeCol(int col)
{
...
//	Return:
//		<none>
void CUGProjectEdit::OnColSizing(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
...
//	Return:
//		<none>
void CUGProjectEdit::OnColSized(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*width);
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CUGProjectEdit::OnCanSizeRow(long row)
{
...
//	Return:
//		<none>
void CUGProjectEdit::OnRowSizing(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUGProjectEdit::OnRowSized(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*height);
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CUGProjectEdit::OnCanSizeSideHdg()
{
	return TRUE;
}
...
int CUGProjectEdit::OnSideHdgSizing(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
int CUGProjectEdit::OnSideHdgSized(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CUGProjectEdit::OnCanSizeTopHdg()
{
	return TRUE;
}
...
//		TRUE - to accept current new size
//		FALSE - to stop sizing, the size is either too large or too small
int CUGProjectEdit::OnTopHdgSizing(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//		TRUE - to accept new size
//		FALSE - to revert to old size
int CUGProjectEdit::OnTopHdgSized(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//	Return:
//		<none>
void CUGProjectEdit::OnColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void CUGProjectEdit::OnRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void CUGProjectEdit::OnCellChange(int oldcol,int newcol,long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
	UNREFERENCED_PARAMETER(oldrow);
...
//	Return:
//		<none>
void CUGProjectEdit::OnLeftColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void CUGProjectEdit::OnTopRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void CUGProjectEdit::OnViewMoved( int nScrolDir, long oldPos, long newPos )
{
...
//	Return:
//		<none>
void CUGProjectEdit::OnSelectionChanged(int startCol,long startRow,int endCol,long endRow,int blockNum)
{
...
//	Return:
//		<none>
void CUGProjectEdit::OnLClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
...
//	Return:
//		<none>
void CUGProjectEdit::OnRClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUGProjectEdit::OnDClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void CUGProjectEdit::OnMouseMove(int col,long row,POINT *point,UINT nFlags,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CUGProjectEdit::OnTH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUGProjectEdit::OnTH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUGProjectEdit::OnTH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void CUGProjectEdit::OnSH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUGProjectEdit::OnSH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUGProjectEdit::OnSH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void CUGProjectEdit::OnCB_LClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CUGProjectEdit::OnCB_RClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CUGProjectEdit::OnCB_DClicked(RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
	UNREFERENCED_PARAMETER(processed);
...
//	Return:
//		<none>
void CUGProjectEdit::OnKeyDown(UINT *vcKey,BOOL processed)
{
...
//	Return:
//		<none>
void CUGProjectEdit::OnKeyUp(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
	//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void CUGProjectEdit::OnCharDown(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
	//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void CUGProjectEdit::OnGetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUGProjectEdit::OnSetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*cell);
...
//	Return:
//		<none>
void CUGProjectEdit::OnDataSourceNotify(int ID,long msg,long param)
{
...
int CUGProjectEdit::OnCellTypeNotify(long ID,int col,long row,long msg,long param)
{
	UNREFERENCED_PARAMETER(ID);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CUGProjectEdit::OnEditStart(int col, long row,CWnd **edit)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CUGProjectEdit::OnEditVerify(int col, long row,CWnd *edit,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int CUGProjectEdit::OnEditFinish(int col, long row,CWnd *edit,LPCTSTR string,BOOL cancelFlag)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int CUGProjectEdit::OnEditContinue(int oldcol,long oldrow,int* newcol,long* newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(*newcol);
...
//	Return:
//		<none>
void CUGProjectEdit::OnMenuCommand(int col,long row,int section,int item)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CUGProjectEdit::OnMenuStart(int col,long row,int section)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
DWORD CUGProjectEdit::OnGetContextHelpID( int col, long row, int section )
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
int CUGProjectEdit::OnHint(int col,long row,int section,CString *string)
{
	UNREFERENCED_PARAMETER(section);
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int CUGProjectEdit::OnVScrollHint(long row,CString *string)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int CUGProjectEdit::OnHScrollHint(int col,CString *string)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
DROPEFFECT CUGProjectEdit::OnDragEnter(COleDataObject* pDataObject)
{
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CUGProjectEdit::OnDragOver(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CUGProjectEdit::OnDragDrop(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUGProjectEdit::OnScreenDCSetup(CDC *dc,int section)
{
...
int CUGProjectEdit::OnSortEvaluate(CUGCell *cell1,CUGCell *cell2,int flags)
{
...
//	Return:
//		<none>
void CUGProjectEdit::OnTabSelected(int ID)
{
	UNREFERENCED_PARAMETER(ID);
}
...
//	Return:
//		<none>
void CUGProjectEdit::OnAdjustComponentSizes(RECT *grid,RECT *topHdg,RECT *sideHdg,
...
//	Return:
//		<none>
void CUGProjectEdit::OnDrawFocusRect(CDC *dc,RECT *rect)
{
...
COLORREF CUGProjectEdit::OnGetDefBackColor(int section)
{
	UNREFERENCED_PARAMETER(section);
...
//		<none>
//
void CUGProjectEdit::OnSetFocus(int section)
{
	UNREFERENCED_PARAMETER(section);
}
...
//	Return:
//		<none>
void CUGProjectEdit::OnKillFocus(int section, CWnd *pNewWnd)
{
	UNREFERENCED_PARAMETER(section);
}
...
BOOL CUGProjectEdit::OnColSwapStart(int col)
{
	UNREFERENCED_PARAMETER(col);
	return TRUE;
}
...
//		TRUE - to allow for the swap to take place
//		FALSE - to disallow the swap
BOOL CUGProjectEdit::OnCanColSwap(int fromCol,int toCol)
{
...
//	Return:
//		<none>
void CUGProjectEdit::OnColSwapped(int fromCol,int toCol)
{
	UNREFERENCED_PARAMETER(fromCol);
	UNREFERENCED_PARAMETER(toCol);
}
...
//	Return:
//		<none>
void CUGProjectEdit::OnTrackingWindowMoved(RECT *origRect,RECT *newRect)
{
	UNREFERENCED_PARAMETER(*origRect);
	UNREFERENCED_PARAMETER(*newRect);
}

void CUGProjectEdit::InitData(CString strClass)
{
	
	try{
		CString strSQL=_T("");
		if(strClass.Compare(_T("全部"))==0 ||strClass.IsEmpty())
		{

			strSQL.Format(_T("select * from Project ;"));
		}
		else
		{
			strSQL.Format(_T("select * from Project where AccountType='%s'"),strClass);
		}
		CUGCell cell;
		CppSQLite3DB db;
		...
		while (!q.eof())
		{
			...
			strBillCode=q.fieldValue(_T("ProjectName"));//项目名称
			QuickSetText(1,i,strBillCode);
			strBillCode=q.fieldValue(_T("AccountType"));//项目类别
...
void CUGProjectEdit::OnSize(UINT nType, int cx, int cy)
{
...
long CUGProjectEdit::GetRowCount(CString strClass)
{
	long nRows=0;
		...
		if(strClass.Compare(_T("全部"))==0 ||strClass.IsEmpty())
		{
			...
			strSQL.Format(_T("select count(*) from Project ;"));
		}
		else
		{
			strSQL.Format(_T("select count(*) from Project where AccountType='%s'"),strClass);
		}

	try{
		CppSQLite3DB db;
		db.open(CBoBoDingApp::g_strDatabasePath);
		nRows= db.execScalar(strSQL);
...
void CUGProjectEdit::SQLQuery(CString strClass)
...
void CUGProjectEdit::InitGrid()
{
	...
	QuickSetText(1,0, _T("项目名称"));//单据日期
	QuickSetText(2,0, _T("项目类别")); 
	QuickSetText(3,0, _T("说明"));
	JoinCells(4,0,5,0);
	...
	CString CUGProjectEdit::GetProjectName(int nCol,long nRow)
	{

		m_strProjectName=QuickGetText(nCol,nRow);

		return m_strProjectName;
	}


	int CUGProjectEdit::OnPushButton(long ID,int col,long row,long msg,long param){
	...
	if(msg == UGCT_BUTTONCLICK){
		...
		/*	CString strYeWuBianHao;
			...
			DlgProjectChange.m_strOldProjectName=m_strProjectName;
		...
		/*		switch (m_nSelect)
			...
			m_strProjectName=QuickGetText(1,GetCurrentRow());
			CString strPrompt;
			strPrompt.Format(_T("您确定要删除 %s 吗？"),m_strProjectName);
			...
			if ((MessageBox(strPrompt,_T("提示"),MB_OKCANCEL)==IDOK))
			{
				...
				try{
					...
					strSQL.Format(_T("DELETE FROM Project WHERE ProjectName='%s'"),(m_strProjectName));
	...
	void CUGProjectEdit::Change()
	{
		ReleaseCapture();
			m_strProjectName=QuickGetText(1,GetCurrentRow());
			if (m_strProjectName.IsEmpty())return;
			CDlgProjectChange DlgProjectChange;
			DlgProjectChange.m_strOldProjectName=m_strProjectName;
			DlgProjectChange.DoModal();
			if (DlgProjectChange.m_bIsSave==true)
