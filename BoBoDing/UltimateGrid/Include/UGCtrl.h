...
//#include "DlgXiaoShouDanPrompt.h"
//class CDlgXiaoShouDanPrompt;
...
protected:
	...
	//afx_msg void OnChangeEdit();//增加 邵盛松
...
public:
		/*******************************************************************/
	//CDlgXiaoShouDanPrompt *m_pDlg;//自动提示窗口 邵盛松
	//void SetPromptText(CString strText);
...
public:
	...
	//CEdit *	m_editCtrl;				//edit control currently being used
