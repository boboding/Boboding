...
BEGIN_MESSAGE_MAP(CUGAddressBook,CUGCtrl)
	//{{AFX_MSG_MAP(CUGAddressBook)
...
/////////////////////////////////////////////////////////////////////////////
// Standard CUGAddressBook construction/destruction
CUGAddressBook::CUGAddressBook()
{
...
{	
	...
	//m_nRows=GetRowCount( oleDateTime_timeFrom, oleDateTime_timeTo,_T("全部客户"))+1;
	InitGrid();
	InitData();
	//InitData( oleDateTime_timeFrom, oleDateTime_timeTo,_T("全部客户"));
...
//	Return:
//		<none>
void CUGAddressBook::OnSheetSetup(int sheetNumber)
{
...
int CUGAddressBook::OnCanMove(int oldcol,long oldrow,int newcol,long newrow)
{
...
int CUGAddressBook::OnCanViewMove(int oldcol,long oldrow,int newcol,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newcol);
...
//	Return:
//		<none>
void CUGAddressBook::OnHitBottom(long numrows,long rowspast,long rowsfound)
{
...
//	Return:
//		<none>
void CUGAddressBook::OnHitTop(long numrows,long rowspast)
{
	UNREFERENCED_PARAMETER(numrows);
	UNREFERENCED_PARAMETER(rowspast);
}
...
int CUGAddressBook::OnCanSizeCol(int col)
{
...
//	Return:
//		<none>
void CUGAddressBook::OnColSizing(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
...
//	Return:
//		<none>
void CUGAddressBook::OnColSized(int col,int *width)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*width);
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CUGAddressBook::OnCanSizeRow(long row)
{
...
//	Return:
//		<none>
void CUGAddressBook::OnRowSizing(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUGAddressBook::OnRowSized(long row,int *height)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*height);
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CUGAddressBook::OnCanSizeSideHdg()
{
	return TRUE;
}
...
int CUGAddressBook::OnSideHdgSizing(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
int CUGAddressBook::OnSideHdgSized(int *width)
{
	UNREFERENCED_PARAMETER(*width);
	return TRUE;
}
...
//		TRUE - to allow sizing
//		FALSE - to prevent sizing
int CUGAddressBook::OnCanSizeTopHdg()
{
	return TRUE;
}
...
//		TRUE - to accept current new size
//		FALSE - to stop sizing, the size is either too large or too small
int CUGAddressBook::OnTopHdgSizing(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//		TRUE - to accept new size
//		FALSE - to revert to old size
int CUGAddressBook::OnTopHdgSized(int *height)
{
	UNREFERENCED_PARAMETER(*height);
	return TRUE;
}
...
//	Return:
//		<none>
void CUGAddressBook::OnColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void CUGAddressBook::OnRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void CUGAddressBook::OnCellChange(int oldcol,int newcol,long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
	UNREFERENCED_PARAMETER(oldrow);
...
//	Return:
//		<none>
void CUGAddressBook::OnLeftColChange(int oldcol,int newcol)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(newcol);
}
...
//	Return:
//		<none>
void CUGAddressBook::OnTopRowChange(long oldrow,long newrow)
{
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(newrow);
}
...
//	Return:
//		<none>
void CUGAddressBook::OnViewMoved( int nScrolDir, long oldPos, long newPos )
{
...
//	Return:
//		<none>
void CUGAddressBook::OnSelectionChanged(int startCol,long startRow,int endCol,long endRow,int blockNum)
{
...
//	Return:
//		<none>
void CUGAddressBook::OnLClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
...
//	Return:
//		<none>
void CUGAddressBook::OnRClicked(int col,long row,int updn,RECT *rect,POINT *point,int processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUGAddressBook::OnDClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void CUGAddressBook::OnMouseMove(int col,long row,POINT *point,UINT nFlags,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CUGAddressBook::OnTH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUGAddressBook::OnTH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUGAddressBook::OnTH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void CUGAddressBook::OnSH_LClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUGAddressBook::OnSH_RClicked(int col,long row,int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(updn);
...
//	Return:
//		<none>
void CUGAddressBook::OnSH_DClicked(int col,long row,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*rect);
...
//	Return:
//		<none>
void CUGAddressBook::OnCB_LClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CUGAddressBook::OnCB_RClicked(int updn,RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(updn);
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
...
//	Return:
//		<none>
void CUGAddressBook::OnCB_DClicked(RECT *rect,POINT *point,BOOL processed)
{
	UNREFERENCED_PARAMETER(*rect);
	UNREFERENCED_PARAMETER(*point);
	UNREFERENCED_PARAMETER(processed);
...
//	Return:
//		<none>
void CUGAddressBook::OnKeyDown(UINT *vcKey,BOOL processed)
{
...
//	Return:
//		<none>
void CUGAddressBook::OnKeyUp(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
	//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void CUGAddressBook::OnCharDown(UINT *vcKey,BOOL processed)
{
	UNREFERENCED_PARAMETER(*vcKey);
	UNREFERENCED_PARAMETER(processed);
	//	GetScrollBarCtrl(SB_HORZ)->EnableScrollBar(ESB_DISABLE_BOTH);
...
//	Return:
//		<none>
void CUGAddressBook::OnGetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUGAddressBook::OnSetCell(int col,long row,CUGCell *cell)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*cell);
...
//	Return:
//		<none>
void CUGAddressBook::OnDataSourceNotify(int ID,long msg,long param)
{
...
int CUGAddressBook::OnCellTypeNotify(long ID,int col,long row,long msg,long param)
{
	UNREFERENCED_PARAMETER(ID);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CUGAddressBook::OnEditStart(int col, long row,CWnd **edit)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CUGAddressBook::OnEditVerify(int col, long row,CWnd *edit,UINT *vcKey)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int CUGAddressBook::OnEditFinish(int col, long row,CWnd *edit,LPCTSTR string,BOOL cancelFlag)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*edit);
...
int CUGAddressBook::OnEditContinue(int oldcol,long oldrow,int* newcol,long* newrow)
{
	UNREFERENCED_PARAMETER(oldcol);
	UNREFERENCED_PARAMETER(oldrow);
	UNREFERENCED_PARAMETER(*newcol);
...
//	Return:
//		<none>
void CUGAddressBook::OnMenuCommand(int col,long row,int section,int item)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
int CUGAddressBook::OnMenuStart(int col,long row,int section)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
DWORD CUGAddressBook::OnGetContextHelpID( int col, long row, int section )
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(section);
...
int CUGAddressBook::OnHint(int col,long row,int section,CString *string)
{
	UNREFERENCED_PARAMETER(section);
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int CUGAddressBook::OnVScrollHint(long row,CString *string)
{
	UNREFERENCED_PARAMETER(row);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
//		TRUE - to show the hint
//		FALSE - to prevent the hint from showing
int CUGAddressBook::OnHScrollHint(int col,CString *string)
{
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(*string);
	return TRUE;
...
DROPEFFECT CUGAddressBook::OnDragEnter(COleDataObject* pDataObject)
{
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CUGAddressBook::OnDragOver(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//		DROPEFFECT_NONE - no drag and drop
//		DROPEFFECT_COPY - allow drag and drop for copying
DROPEFFECT CUGAddressBook::OnDragDrop(COleDataObject* pDataObject,int col,long row)
{
	UNREFERENCED_PARAMETER(*pDataObject);
	UNREFERENCED_PARAMETER(col);
	UNREFERENCED_PARAMETER(row);
...
//	Return:
//		<none>
void CUGAddressBook::OnScreenDCSetup(CDC *dc,int section)
{
...
int CUGAddressBook::OnSortEvaluate(CUGCell *cell1,CUGCell *cell2,int flags)
{
...
//	Return:
//		<none>
void CUGAddressBook::OnTabSelected(int ID)
{
	UNREFERENCED_PARAMETER(ID);
}
...
//	Return:
//		<none>
void CUGAddressBook::OnAdjustComponentSizes(RECT *grid,RECT *topHdg,RECT *sideHdg,
...
//	Return:
//		<none>
void CUGAddressBook::OnDrawFocusRect(CDC *dc,RECT *rect)
{
...
COLORREF CUGAddressBook::OnGetDefBackColor(int section)
{
	UNREFERENCED_PARAMETER(section);
...
//		<none>
//
void CUGAddressBook::OnSetFocus(int section)
{
	UNREFERENCED_PARAMETER(section);
}
...
//	Return:
//		<none>
void CUGAddressBook::OnKillFocus(int section, CWnd *pNewWnd)
{
	UNREFERENCED_PARAMETER(section);
}
...
BOOL CUGAddressBook::OnColSwapStart(int col)
{
	UNREFERENCED_PARAMETER(col);
	return TRUE;
}
...
//		TRUE - to allow for the swap to take place
//		FALSE - to disallow the swap
BOOL CUGAddressBook::OnCanColSwap(int fromCol,int toCol)
{
...
//	Return:
//		<none>
void CUGAddressBook::OnColSwapped(int fromCol,int toCol)
{
	UNREFERENCED_PARAMETER(fromCol);
	UNREFERENCED_PARAMETER(toCol);
}
...
//	Return:
//		<none>
void CUGAddressBook::OnTrackingWindowMoved(RECT *origRect,RECT *newRect)
{
	UNREFERENCED_PARAMETER(*origRect);
	UNREFERENCED_PARAMETER(*newRect);
}

void CUGAddressBook::InitData(COleDateTime oleDateTimeFrom,COleDateTime oleDateTimeTo,CString strKehu)
{
	...
	//try{
	//	CString strSQL=_T("");
	//	if(strKehu.Compare(_T("全部客户"))==0 ||strKehu.IsEmpty() )
	//	{
	...
	//		strBillCode=q.fieldValue(_T("XiaoShouRiQi"));//销售日期
	//		QuickSetText(1,i,strBillCode);
	//		strBillCode=q.fieldValue(_T("DanJuBianHao"));//单据编号
	//		QuickSetText(2,i,strBillCode);
	//		strBillCode=q.fieldValue(_T("KeHuMingCheng"));//客户名称
	//		QuickSetText(3,i,strBillCode);
	//		strBillCode=q.fieldValue(_T("XiaoShouJinE"));//销售金额
	//		QuickSetText(4,i,strBillCode);
	//		strBillCode=q.fieldValue(_T("ZheHouJinE"));//折后金额
	//		QuickSetText(5,i,strBillCode);
	//		strBillCode=q.fieldValue(_T("ShouKuanJinE"));//收款金额

	//		QuickSetText(6,i,strBillCode);
	//		strBillCode=q.fieldValue(_T("ShuoMing"));//说明
...
void CUGAddressBook::OnSize(UINT nType, int cx, int cy)
{
...
long CUGAddressBook::GetRowCount()//COleDateTime oleDateTimeFrom,COleDateTime oleDateTimeTo,CString strKehu
{
	long nRows=0;


	CString strSQL=_T("");
	strSQL.Format(_T("select count(*) from AddressBook"));
	try{
		CppSQLite3DB db;
		db.open(CBoBoDingApp::g_strDatabasePath);
...
// 获取单据编号
CString CUGAddressBook::GetDanJuBianHao(int nCol,long nRow)
{
	m_strDanJuBianHao=QuickGetText(nCol,nRow);

	return m_strDanJuBianHao;
}
void CUGAddressBook::SQLQuery(COleDateTime oleDateTimeFrom,COleDateTime oleDateTimeTo,CString strKehu)
{
...
double CUGAddressBook::GetHeJiXiaoShouJinE()
{
	double nSum=0;
...
double  CUGAddressBook::GetHeJiZheHouJinE()
{
	double nSum=0;
...
double  CUGAddressBook::GetHeJiShouKuanJinE()
{
	double nSum=0;
...
void CUGAddressBook:: InitData()
{
	...
	try{
		CString strSQL=_T("");
		strSQL.Format(_T("select * from  Addressbook ORDER BY ID DESC"));
		/*if(strKehu.Compare(_T("全部客户"))==0 ||strKehu.IsEmpty() )
		...
		while (!q.eof())
		{
			...
			strBillCode=q.fieldValue(_T("Name"));//销售日期
			QuickSetText(1,i,strBillCode);

			strBillCode=q.fieldValue(_T("Tel"));//单据编号
			QuickSetText(2,i,strBillCode);

			strBillCode=q.fieldValue(_T("Address"));//客户名称
			QuickSetText(3,i,strBillCode);
			strBillCode=q.fieldValue(_T("Remark"));//销售金额
			QuickSetText(4,i,strBillCode);
			//strBillCode=q.fieldValue(_T("ZheHouJinE"));//折后金额
			for (int j=1;j<5;j++)
			{
...
int CUGAddressBook::OnPushButton(long ID,int col,long row,long msg,long param){
	...
	if(msg == UGCT_BUTTONCLICK){
		if(nParam == BUTTON_CLICK_CHANGE){
			...
			ReleaseCapture();
			CDlgAddressBookChange DlgAddressBookChange;

			DlgAddressBookChange.m_strID=QuickGetText(7,row);
			DlgAddressBookChange.DoModal();
			if (DlgAddressBookChange.m_bIsSave)
			{
			...
			if ((MessageBox(strPrompt,_T("提示"),MB_OKCANCEL)==IDOK))
			{
				...
				try{
					...
					db.open(CBoBoDingApp::g_strDatabasePath);//打开数据库
					db.execDML(_T("BEGIN TRANSACTION;"));
					strSQL.Format(_T("DELETE FROM AddressBook WHERE ID='%s'"),QuickGetText(7,row));
...
void CUGAddressBook::Query(int nSelect,CString strCondition)
{
	//首先清空网格的数据
	//第二 获取符合条件的记录个数
	//	第三 写入界面
	...
	{
	case 0://姓名 
		strSQL.Format(_T("select * from AddressBook where Name like '%s%%' ORDER BY ID DESC"),strCondition);
		break;
	case 1:// 电话
		strSQL.Format(_T("select * from AddressBook where Tel like '%s%%' ORDER BY ID DESC"),strCondition);
		break;
	case 2:// 地址
		strSQL.Format(_T("select  * from AddressBook where Address like '%s%%' ORDER BY ID DESC"),strCondition);
		break;
	case 3:// 备注
		strSQL.Format(_T("select  * from AddressBook where Remark like '%s%%' ORDER BY ID DESC"),strCondition);
		break;

	case 4://类别
		strSQL.Format(_T("select * from AddressBook where CategoryName='%s'"),strCondition);
		break;
...
long CUGAddressBook::GetRowCount(int nSelect,CString strCondition)
{
	long nRows=0;
	...
	{
	case 0://姓名 
		strSQL.Format(_T("select count(*) from AddressBook where Name like '%s%%'"),strCondition);
		break;
	case 1:// 电话
		strSQL.Format(_T("select count(*) from AddressBook where Tel like '%s%%'"),strCondition);
		break;
	case 2:// 地址
		strSQL.Format(_T("select count(*) from AddressBook where Address like '%s%%'"),strCondition);
		break;
	case 3:// 备注
		strSQL.Format(_T("select count(*) from AddressBook where Remark like '%s%%'"),strCondition);
		break;
	case 4:// 备注
		strSQL.Format(_T("select count(*) from AddressBook where CategoryName='%s'"),strCondition);
		break;
	default:// 全部 //选择
		strSQL.Format(_T("select count(*) from AddressBook"));
		break;
...
CString CUGAddressBook::GetID()
{

	return QuickGetText(COLADDRESSBOOKID,m_nLightRow);
}
void CUGAddressBook::Change()
{
	...
	DlgAddressBookChange.m_strID=strTemp;
	DlgAddressBookChange.DoModal();
	if (DlgAddressBookChange.m_bIsSave)
	{
...
void CUGAddressBook::Del()
{
	...
	if ((MessageBox(strPrompt,_T("提示"),MB_OKCANCEL)==IDOK))
	{
		...
		try{
			...
			db.open(CBoBoDingApp::g_strDatabasePath);//打开数据库
			db.execDML(_T("BEGIN TRANSACTION;"));
			strSQL.Format(_T("DELETE FROM AddressBook WHERE ID='%s'"),GetID());
...
void CUGAddressBook::Export()
{
	CString strFilePathName;
	CFileDialog dlg(FALSE,_T("xls"),_T("人脉"),OFN_HIDEREADONLY|OFN_OVERWRITEPROMPT,_T("表格文件(*.xls)|*.xls|所有文件(*.*)|*.*||"));///TRUE为OPEN对话框，FALSE为SAVE AS对话框
	if(dlg.DoModal()==IDOK)
	{
		...
		if (!strFilePathName.IsEmpty())
		{
			...
			if (sheet)
			{
				...
				for (int i=0;i<m_nRows;i++)
				{
					for (int j=1;j<m_nCols-3;j++)//删除 修改 ID
					{
						k=j-1;
...
char* CUGAddressBook::StringToChar(CString strOriginal)
{
